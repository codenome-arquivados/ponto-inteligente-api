...
import com.aimbra.pontoeletronico.api.repositories.LancamentoRepository;
import com.aimbra.pontoeletronico.api.services.LancamentoService;
...
public class LancamentoServiceImpl implements LancamentoService {
    ...
    public Optional<Lancamento> buscaPorId(Long id) {
        log.info("Buscaando o lançamento pelo id {}", id);
        return Optional.ofNullable(this.lancamentoRepository.findById(id).orElse(null));
    }

    @Override
    public Lancamento persistir(Lancamento lancamento) {
        log.info("Persistindo dados do lancamento {}", lancamento);
        return this.lancamentoRepository.save(lancamento);
    }

    @Override
    public void remover(Long id) {
        log.info("Removendo o lancamento com o id {}", id);
